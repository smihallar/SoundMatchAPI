...
namespace SoundMatchAPI.Data.Interfaces.ServiceInterfaces
{
    ...
    {
        Task<ReturnResponse<List<UserResponse>>> GetAllUsersAsync();
        ...
        Task<ReturnResponse<UserProfileResponse>> UpdateUserBioAsync(string userId, string bio, string loggedInUserId);
    }
}
